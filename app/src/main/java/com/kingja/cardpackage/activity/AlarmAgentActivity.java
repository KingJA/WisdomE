 ...
 */
public class AlarmAgentActivity extends BackTitleActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static void goActivity(Activity activity, String houseId) {
        Intent intent = new Intent(activity, AlarmAgentActivity.class);
