...
public class LocationTask implements AMapLocationListener,
    ...
    public LocationTask getInstance(Context context) {
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (amapLocation != null && amapLocation.getAMapException() != null
            ...
            DataManager.putProvince(amapLocation.getProvince());
            DataManager.putCity(amapLocation.getCity());
            DataManager.putDistrict(amapLocation.getDistrict());
